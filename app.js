...
const pintarCards = data => {
    data.forEach(producto => {
        templeteCard.querySelector("h5").textContent = producto.title;
        templeteCard.querySelector("p").textContent = producto.precio;
        templeteCard.querySelector("img").setAttribute("src", producto.thumbnailUrl);
        templeteCard.querySelector(".btn-dark").dataset.id = producto.id;
